...
export async function GET(request: NextRequest, { params }: { params: { id: string } }) {
    ...
    const match = {
        ...
        matchAvgA1: await findMatchAvg(String(match1.matchId), String(match1.playerA.playerId)),
        matchAvgA2: await findMatchAvg(String(match2.matchId), String(match2.playerA.playerId)),
        matchAvgA3: await findMatchAvg(String(match3.matchId), String(match3.playerA.playerId)),
        matchAvgA4: await findMatchAvg(String(match4.matchId), String(match4.playerA.playerId)),
        matchAvgA5: await findMatchAvg(String(match5.matchId), String(match5.playerA.playerId)),
        matchAvgA6: await findMatchAvg(String(match6.matchId), String(match6.playerA.playerId)),
        matchAvgB1: await findMatchAvg(String(match1.matchId), String(match1.playerB.playerId)),
        matchAvgB2: await findMatchAvg(String(match2.matchId), String(match2.playerB.playerId)),
        matchAvgB3: await findMatchAvg(String(match3.matchId), String(match3.playerB.playerId)),
        matchAvgB4: await findMatchAvg(String(match4.matchId), String(match4.playerB.playerId)),
        matchAvgB5: await findMatchAvg(String(match5.matchId), String(match5.playerB.playerId)),
        matchAvgB6: await findMatchAvg(String(match6.matchId), String(match6.playerB.playerId)),
    }
